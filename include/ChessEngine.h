...
private:
	...
	// Board state
	__declspec(align(64)) int m_board[128];
...
public:
	...
	*/
	int generatePseudoLegalMoves(int* __restrict pseudoLegalMoves, int* __restrict piecePositions, int* __restrict board, int* __restrict lookup, char castlingRights, int enpassantSquare, int colourToPlay, int blackKingSquare, int whiteKingSquare);

	inline void generatePawnWhite(int* __restrict pseudoLegalMoves, int &index, int sourceSquare, int colourToPlay, int enpassantSquare, int* board, int* lookup);
	inline void generatePawnBlack(int* __restrict pseudoLegalMoves, int &index, int sourceSquare, int colourToPlay, int enpassantSquare, int* board, int* lookup);
	inline void generateKnight(int* __restrict pseudoLegalMoves, int &index, int sourceSquare, int colourToPlay, int* board, int* lookup);
	inline void generateDiagonal(int* __restrict pseudoLegalMoves, int &index, int max, int sourceSquare, int colourToPlay, int* board, int* lookup);
	inline void generateSraight(int* __restrict pseudoLegalMoves, int &index, int max, int sourceSquare, int colourToPlay, int* board, int* lookup);
	inline void generateKingWhite(int* __restrict pseudoLegalMoves, int &index, int sourceSquare, int* board, int* lookup, char castlingRights);
	inline void generateKingBlack(int* __restrict pseudoLegalMoves, int &index, int sourceSquare, int* board, int* lookup, char castlingRights);
	...
	*/
	...
	int makeMove(int encodedMove, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	void unmakeMove(int encodedMove, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	bool verifyMove(int encodedMove, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	...
	void perft(int depthLeft, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	...
	/// <param name="lookupPiece"> The index of each piece in the piecePositions array </param>
	/// <returns> </returns>
	int ABMax(int alpha, int beta, int depthLeft, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	...
	/// <param name="lookupPiece"> The index of each piece in the piecePositions array </param>
	/// <returns> </returns>
	int ABMin(int alpha, int beta, int depthLeft, int encodedInfo, int* __restrict board, int* __restrict piecePositions, int* __restrict lookupPiece);
	...
	* Move ordering
	*/
	void moveOrdering(int* __restrict pseudoLegalMoves, int moveNum);
};
